                  ...
                  Container(
                    ...
                    child: Column(children: [
                     ...
                     // PortionWidget(icon: Images.aboutIcon, title: 'about_us'.tr, route: RouteHelper.getHtmlRoute('about-us')),
                      PortionWidget(icon: Images.termsIcon, title: 'terms_conditions'.tr,onTap: () {
                        
                      }, route: RouteHelper.getHtmlRoute('terms-and-condition')
                      ),
                      PortionWidget(icon: Images.privacyIcon, title: 'privacy_policy'.tr,onTap: () {
                        
                      },  route: RouteHelper.getHtmlRoute('privacy-policy')),

                      // (Get.find<SplashController>().configModel!.refundPolicyStatus == 1 ) ? PortionWidget(
                      //     icon: Images.refundIcon, title: 'refund_policy'.tr,onTap: () {
